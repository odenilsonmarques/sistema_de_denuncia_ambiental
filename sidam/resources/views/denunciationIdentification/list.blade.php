        ...
        <div class="row">
            <div class="col-lg-8 mt-5">
                <div class="input-group">
                    <form action="{{route('search.identification')}}" method="POST" class="form-horizontal">
                        @csrf
            ...
            <div class="col-lg-4 mt-5">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-2">
                    <a href="{{route('identification.listPdfIdentification')}}" target="_blank" class="btn btn-primary" role="button">
                        ...
                        <tbody>
                            @foreach($denunciationIdentifications as $denunciationIdentification)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('denunciation.detailsIdentification', $denunciationIdentification->id)}}" class="btn btn-primary btn-sm">
