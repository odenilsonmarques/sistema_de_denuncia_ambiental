...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-9 mt-5 ">
            <div class="card">
                <form action="{{route('complaint.identification.editAction', $data->id)}}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6 mt-4">
                                <button class="btn btn-danger"><a href="{{route('complaint.identification.list')}}">CANCELAR </a></button>
