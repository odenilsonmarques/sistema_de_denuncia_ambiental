...
@section('content')
    <div class="container">
        <div class="row">
            <h1 class="text-center question">Como deseja denunciar ?</h1>
            <div class="col-sm-12 text-center mt-5">
                <button type="button" class="btn btn-success btn-lg">
                    <a href="{{route('login')}}">
                        ...
                        <strong>Acessando sua conta</strong>
                    </a>
                </button>
                ...
                <button type="button" class="btn bg-secondary btn-lg">
                    <a href="{{route('complaint.anonymou.add')}}" data-bs-toggle="modal" data-bs-target="#exampleModal">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary"><a href="{{route('complaint.anonymou.add')}}">Continuar</a> </button>
                        </div>
                    </div>
                </div>
            </div>
