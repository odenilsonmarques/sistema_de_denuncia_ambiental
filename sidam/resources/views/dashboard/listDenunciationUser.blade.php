                        ...
                        <tbody>
                            @foreach($denunciations as $denunciationUser)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('complaint.identification.detailsIdentification',$denunciationUser->id)}}" class="btn btn-primary btn-sm">
                                    ...
                                    <td >
                                        <a href="{{route('complaint.identification.detailsIdentification',$denunciationUser->id)}}" class="btn btn-primary btn-sm" data-bs-toggle="modal"  data-bs-target="#exampleModal">Modal</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
